...
// fn (f *File) Name() string { return f.name }
...
// fn (e *LinkError) Error() string {
// 	return e.Op + " " + e.Old + " " + e.New + ": " + e.Err.Error()
// }

// fn (e *LinkError) Unwrap() error {
// 	return e.Err
// }
...
// fn (f *File) ReadAt(b []byte, off int64) (n int, err error) {
// 	if err := f.checkValid("read"); err != nil {
// 		return 0, err
// 	}
...
// fn (f *File) ReadFrom(r io.Reader) (n int64, err error) {
...
// fn genericReadFrom(f *File, r io.Reader) (int64, error) {
...
// fn (f *File) WriteAt(b []byte, off int64) (n int, err error) {
// 	if err := f.checkValid("write"); err != nil {
// 		return 0, err
// 	}
// 	if f.appendMode {
...
// // a slice of bytes.
// fn (f *File) WriteString(s string) (n int, err error) {
...
// // If there is an error, it will be of type *PathError.
// fn OpenFile(name string, flag int, perm FileMode) (*File, error) {
// 	testlog.Open(name)
...
// fn Rename(oldpath, newpath string) error {
// 	return rename(oldpath, newpath)
// }

// // Many functions in package syscall return a count of -1 instead of 0.
// // Using fixCount(call()) instead of call() corrects the count.
// fn fixCount(n int, err error) (int, error) {
// 	if n < 0 {
// 		n = 0
// 	}
// 	return n, err
...
// fn (f *File) wrapErr(op string, err error) error {
...
// fn Chmod(name string, mode FileMode) error { return chmod(name, mode) }

// // Chmod changes the mode of the file to mode.
// // If there is an error, it will be of type *PathError.
// fn (f *File) Chmod(mode FileMode) error { return f.chmod(mode) }
...
// fn (f *File) SyscallConn() (syscall.RawConn, error) {
...
// fn (dir dirFS) Open(name string) (fs.File, error) {
...
// fn (dir dirFS) Stat(name string) (fs.FileInfo, error) {
// 	fullname, err := dir.join(name)
// 	if err != nil {
// 		return nil, &PathError{Op: "stat", Path: name, Err: err}
// 	}
...
// fn (dir dirFS) join(name string) (string, error) {
// 	if dir == "" {
...
pub fn read_file(name: &str) -> std::io::Result<Vec<u8>> {
