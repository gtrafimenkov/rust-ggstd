...
// 				t.Errorf("Is({}, {}) = {}, want {}", tc.err, tc.target, got, tc.match)
// 			}
// 		})
// 	}
// }
...
// 		name := fmt.Sprintf("{}:As(Errorf(..., {}), {})", i, tc.err, tc.target)
...
// 			if match != tc.match {
// 				t.Fatalf("match: got {}; want {}", match, tc.match)
// 			}
// 			if !match {
// 				return
// 			}
...
// 	for _, tc := range testCases {
// 		t.Run(fmt.Sprintf("%T({})", tc, tc), func(t *testing.T) {
// 			defer func() {
// 				recover()
// 			}()
// 			if errors.As(err, tc) {
// 				t.Errorf("As(err, %T({})) = true, want false", tc, tc)
// 				return
// 			}
// 			t.Errorf("As(err, %T({})) did not panic", tc, tc)
// 		})
// 	}
// }
...
// 			t.Errorf("Unwrap({}) = {}, want {}", tc.err, got, tc.want)
// 		}
// 	}
// }
